...
{
    public interface IPostfixStarPatternMatcher
    {
        /// <summary>
        /// Basic Regex Parser
        ...
        /// text matches the pattern as a regular expression.
        /// 
        ...
        /// if the text and pattern are the equal, where the '.' is treated as a single
        /// a character wildcard (see third example), and '*' is matched for a zero
        /// or more sequence of the previous letter(see fourth and fifth examples).
        /// For more information on regular expression matching,
